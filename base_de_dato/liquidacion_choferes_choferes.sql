...
CREATE TABLE `choferes` (
  ...
  CONSTRAINT `choferes_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `inicio_sesion` (`id_usuario`)
...
INSERT INTO `choferes` VALUES (1,3,'Facundo Pedrido','LEG-001','Tienda León');
